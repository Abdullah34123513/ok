...
const Header: React.FC<HeaderProps> = ({ searchQuery, onSearchChange, title, onBack, onNavigate }) => {
      ...
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        {title ? (
            <div className="flex items-center space-x-2 flex-1">
                <button onClick={onBack} className="p-2 -ml-2 rounded-full hover:bg-gray-100 transition">
                    <ArrowLeftIcon />
                </button>
        ...
        <div className="flex items-center space-x-4">
          <button onClick={() => onNavigate?.('cart')} className="relative p-2 rounded-full hover:bg-gray-100 transition">
            <CartIcon />
            {cartCount > 0 && (
          ...
          <button onClick={handleProfileClick} className="p-2 rounded-full hover:bg-gray-100 transition">
            <ProfileIcon />
          </button>
        </div>
      </div>
