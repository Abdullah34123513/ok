...
import type { Food, Restaurant, Review, MenuItem, SelectedCustomization, CustomizationOption, CustomizationChoice } from '../types';
...
const FoodDetailPage: React.FC<FoodDetailPageProps> = ({ foodId, location }) => {
    ...
    const currentPrice = useMemo(() => {
        ...
        // FIX: Add explicit type annotation to the 'choices' parameter to resolve the 'unknown' type inference error from Object.values.
    ...
    const handleAddToCart = () => {
        ...
        // FIX: Add explicit type annotation to the destructured 'choices' array to resolve 'unknown' type errors during mapping and filtering.
        const finalCustomizations: SelectedCustomization[] = Object.entries(selectedCustomizations)
            ...
            // This filter now works because `cust.choices` is correctly typed as an array.
